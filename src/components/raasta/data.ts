...
export const mockScenarios = {
  ...
  usClient: { prompt: "A US client is paying me $3,000 for web development. I use Payoneer and Meezan, and the payment is due today.", overrides: { Client: "United States", Amount: "$3,000", "Payment source": "Direct client" } },
  upwork: { prompt: "I need to withdraw my freelance earnings from Upwork to Pakistan.", overrides: { Client: "International clients", Amount: "Amount not provided", "Payment source": "Upwork", "Existing payment route": "Upwork withdrawal", Timing: "Not specified" } },
  keepUsd: { prompt: "I want to receive freelance income in Pakistan and keep part of it in USD.", overrides: { Client: "Not specified", Amount: "Amount not provided", "Keep foreign currency": "Yes — USD", Timing: "Not specified" } },
  islamic: { prompt: "I want a payment route that matches my Islamic banking preference.", overrides: { Client: "Not specified", Amount: "Amount not provided", "Islamic banking": "Preferred", Timing: "Not specified" } },
  wiseOnly: { prompt: "My client only uses Wise. How should I receive the payment in Pakistan?", overrides: { Client: "Not specified", Amount: "Amount not provided", "Payment source": "Direct client via Wise", "Existing payment route": "Wise sender", Timing: "Not specified" } },
  psebUnknown: { prompt: "I don't know what PSEB is, but I need to receive freelance income in Pakistan.", overrides: { Client: "Not specified", Amount: "Amount not provided", PSEB: "Not sure", Timing: "Not specified" } },
} as const;
